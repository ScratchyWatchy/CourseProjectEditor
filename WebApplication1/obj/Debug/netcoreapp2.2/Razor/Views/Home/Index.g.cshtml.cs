#pragma checksum "C:\Users\akhruslov\Documents\PureJsEditor\WebApplication1\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "425d9a43065a6dad55584753b6216707b7feb56e"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"425d9a43065a6dad55584753b6216707b7feb56e", @"/Views/Home/Index.cshtml")]
    ...
    public class Views_Home_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            ...
            EndContext();
            BeginContext(25, 25249, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "425d9a43065a6dad55584753b6216707b7feb56e3711", async() => {
                BeginContext(31, 25236, true);
                WriteLiteral(@"
    <meta charset=""UTF-8"">
    ...
    <script id=""code"">
        ...
        function init() {
            ...
            myDiagram =
                $(go.Diagram, ""myDiagramDiv"",  // create a");
                WriteLiteral(@" new Diagram in the HTML DIV element ""myDiagramDiv""
                    {
            ...
            var palette2");
                WriteLiteral(@" = new go.Palette(""palette2"");  // create a new Palette in the HTML DIV element ""palette""
                ...
                $(go.Link,
                    {
                        ...
                        relinkableTo: true,
                        selectionAdorned:
                            false, // Links are not adorned when selected so that their color remains visible.
                    ...
                    $(go.Shape,
                        { name: ""SH");
                WriteLiteral(@"APE"", strokeWidth: 2, stroke: red }),
                    $(go.TextBlock,
            ...
            ");
                WriteLiteral(@"        fromLinkable: !input,
                    toSpot: go.Spot.Left,
                    toLinkable: input,
                    toMaxLinks: 1,
                    cursor: ""pointer""
          ...
          ");
                WriteLiteral(@"                  var shp = obj.findObject(""NODESHAPE"");
            ...
            var outputTemplate =
                $(go.Node, ""Spot"", nodeStyle(),
                    ...
                    $(go.TextBlock, """",
                      ...
                      ");
                WriteLiteral(@"      font: '10pt  Segoe UI,sans-serif', stroke: 'Black'
                        },
            ...
            var orTemplate =
                $(go.Node, ""Spot"", nodeStyle(),
                    ...
                    $(go.Shape, ""Rectangle"", portStyle(true),
                        { portId: ""in1"", alignment: new go.Spot(0");
                WriteLiteral(@".16, 0.3) }),
                    $(go.Shape, ""Rectangle"", portStyle(true),
            ...
            var xnorTemplate =
                $(go.Node, ""Spot"", nodeStyle(),
                    ...
                    $(go.Shape, ""Rectangle"", portStyle(true),
                        { portId: ""in2"", alignment: new go.Spot(0.26, 0.7) }),
                    $(go.Shape, ""Rectangle"", portStyle(false),
                        { portId: ""out"", alignment: new go.Spot");
                WriteLiteral(@"(1, 0.5) })
                );
            ...
            var addTemplate =
                $(go.Node, ""Spot"", nodeStyle(),
                    $(go.Shape, ""Squar");
                WriteLiteral(@"eArrow"", shapeStyle()),
                    $(go.Shape, ""Rectangle"", portStyle(true),
                        { portId: ""in1"", alignment: new go.Spot(0, 0.3) }),
                    $(go.Shape, ""Rectangle"", portStyle(true),
                        { portId: ""in2"", alignment: new go.Spot(0, 0.7) }),
            ...
            var multiplyTemplate =
             ...
             ");
                WriteLiteral(@"       $(go.Shape, ""Rectangle"", portStyle(true),
                        { portId: ""in1"", alignment: new go.Spot(0, 0.3) }),
                    $(go.Shape, ""Rectangle"", portStyle(true),
                        { portId: ""in2"", alignment: new go.Spot(0, 0.7) }),
                    $(go.Shape, ""Rectangle"", portStyle(false),
                    ...
                    $(go.TextBlock, ""/"",
                        {
                            wrap: go.TextBlock.None, width: 25,
                            isMultiline: false, editable: false, textAlign: 'center',
                            font: '15pt  Segoe UI, bold, sans-serif', stroke: 'Black'
                        },
                        new go.Binding(""text"", ""data"").makeTwoWay())
                );
            ...
            var percentTemplate =
                $(go.Node, ""Spot"", nodeStyle(),
                    ...
                    $(go.Shape, ""Rectangle"", portStyle(true),
                    ");
                WriteLiteral(@"    { portId: ""in"", alignment: new go.Spot(0, 0.5) }),
                    $(go.Shape, ""Rectangle"", portStyle(false),
                        { portId: ""out"", alignment: new go.Spot(1, 0.5) }),
            $(go.TextBlock, ""1"",
                {
            ...
            myDi");
                WriteLiteral(@"agram.nodeTemplateMap.add(""not"", notTemplate);
 ...
 ");
        ...
        function updateStates() {
            ...
            ");
                WriteLiteral(@"    case ""one"": doOne(node); break;
        ...
        // determine the color of links coming out of this node based on ");
                WriteLiteral(@"those coming in and node type
...
");
        ...
        f");
                WriteLiteral(@"unction doDivide(node) {
            var additionResult = 0;
        ...
        function doPercent(node) {
            ...
            result /= 100;
            node.findLinksInto().each(function (link) { result *= par");
                WriteLiteral(@"seFloat(link.findObject(""displayText"").text) });
            var color = ""lightblue"";
...
");
            ...
            EndContext();
            BeginContext(25274, 2, true);
            WriteLiteral("\r\n");
            EndContext();
            BeginContext(25276, 3299, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "425d9a43065a6dad55584753b6216707b7feb56e31491", async() => {
                BeginContext(25298, 3270, true);
                WriteLiteral(@"
...
{ ""class"": ""GraphLinksModel"",
  ...
  ""linkToPortIdProperty"": ""toPort"",");
                WriteLiteral(@"
  ""nodeDataArray"": [ 
{""category"":""one"", ""key"":-10, ""loc"":""-330 -160""},
...
{""category"":""");
                WriteLiteral(@"output"", ""key"":-21, ""loc"":""250 -200""},
